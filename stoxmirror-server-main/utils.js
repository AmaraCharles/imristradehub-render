      ...
      html: `
        ...
        <body>
          <div class="container">
            ...
            <div class="footer">
              <p>Best regards,<br>Methtradehub Team</p>
              <p style="font-size: 12px; color: #888;">© ${new Date().getFullYear()} Methtradehub. All rights reserved.</p>
            </div>
          </div>
        </body>
        </html>
...
const sendWelcomeEmail = async ({ to, otp }) => {
  try {
    await resend.emails.send({
      from: process.env.EMAIL_USER,
      to: to,
      subject: "Verify Your Methtradehub Account",
      html: `
        <!DOCTYPE html>
        <html lang="en">
        <head>
          <meta charset="UTF-8" />
          <meta name="viewport" content="width=device-width, initial-scale=1.0" />
          <title>Methtradehub Verification</title>
          <style>
            body {
        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              ...
              <p>Hello,</p>
              <p>Thank you for creating an account with <strong>Methtradehub</strong>. To protect your account, please use the verification code below to complete your registration:</p>

              <div class="otp-box">
                ${otp}
              </div>

              <p>This code will expire in <strong>5 minutes</strong>. For your security, never share this code with anyone—even a Methtradehub representative.</p>

              <div class="note">
                If you didn’t sign up for a Methtradehub account, please ignore this email or contact our support team immediately.
              </div>
            </div>
            <div class="footer">
