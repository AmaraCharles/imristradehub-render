...
//     to: "support@Methtradehub.com ", // list of receivers
...
const sendTicketEmail = async ({ name, complaint,email }) => {
  ...
  let info = await transporter.sendMail({
    from: `"Methtradehub Team" <${process.env.EMAIL_USER}>`, // sender address
    ...
    html: `
      ...
      <body>
        <div class="email-container">
          <div class="header">
            <img src="cid:logo" alt="Methtradehub Logo">
          ...
          <div class="footer">
            <p>
              If you did not sign up for Methtradehub, please ignore this email or
...
const sendAdminTicketEmail = async ({ name, complaint,email }) => {
  ...
  let info = await transporter.sendMail({
    from: `"Methtradehub Team" <${process.env.EMAIL_USER}>`, // sender address
    to: "support@Methtradehub.com", // recipient address
    subject: "Ticket Registered!", // subject line
    html: `
      <html>
      <head>
...
const sendForgotPasswordEmail = async (email) => {
  ...
  let info = await transporter.sendMail({
    ...
    <a href="https://Methtradehub.com/reset-password">
    reset password
    </p>
...
const sendVerificationEmail = async ({ from, url }) => {
  ...
  let info = await transporter.sendMail({
    ...
    <p>${from} just verified his Methtradehub Team Identity
    </p>
...
const sendWelcomeEmail = async ({ to, otp }) => {
  ...
  let info = await transporter.sendMail({
    ...
    subject: "Welcome to Methtradehub!", // subject line
    html: `
      <html>
      <head>
        <style>
      ...
      <body>
        <div class="email-container">
          ...
          <div class="content">
            ...
            <p>
              Thank you for joining Methtradehub! We're excited to have you on board.
...
//'<a href="https://Methtradehub.com/Methtradehub.com/verified.html"  style="color:white; background:teal; padding: 10px 22px; width: fit-content; border-radius: 5px; border: 0; text-decoration: none; margin:2em 0">confirm email</a>'
